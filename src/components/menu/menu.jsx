...
const Menu = () => {
  ...
  return (
    <div className="menu-button" >
      ...
      <ul className="all-menu list-group " style={{ display: hide || "block" , zIndex: 10, backgroundColor: colors.white}} >
        <li className="list-group-item list-group-item-success" style={{backgroundColor: colors.bgcl}} >
